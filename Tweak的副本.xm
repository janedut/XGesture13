    ...
    @autoreleasepool {
        if (1) {
            [[NSNotificationCenter defaultCenter] addObserverForName:UIKeyboardDidShowNotification object:nil queue:nil usingBlock:^(NSNotification *n){
                    ...
                    [[NSNotificationCenter defaultCenter] addObserverForName:UILongPressGestureRecognizerDidShowNotification object:nil queue:nil usingBlock:^(NSNotification *n){
                               disableGestures = true;
                            }];
            [[NSNotificationCenter defaultCenter] addObserverForName:UIKeyboardWillHideNotification object:nil queue:nil usingBlock:^(NSNotification *n){
                    ...
                    [[NSNotificationCenter defaultCenter] addObserverForName:UILongPressGestureRecognizerWillHideNotification object:nil queue:nil usingBlock:^(NSNotification *n){
                               disableGestures = false;
                            }];
